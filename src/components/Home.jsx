...
const Home = () => {
  ...
  return (
    <div name='home' className="w-full h-screen bg-primary">
      ...
      {/* Container */}
      <div className={`fade-container ${isVisible ? 'opacity-0' : 'opacity-100'} w-full px-10 mx-auto justify-center flex gap-4 h-full`}>
        <div className='w-full px-8 flex flex-col justify-center items-center h-full'>
          <p className='text-[#ffffff] font-bold text-4xl'>Hi, my name is</p>
          <div className='flickering-element text-center p-12 m-8 rounded-3xl border-4 border-pink flex flex-col items-center'>
          ...
          <h3 className='text-text_light py-4 max-w-[700px] text-center text-2xl'>
          ...
          <div className='w-full flex justify-center'>
            <button onClick={handleDownload} className='text-text_light z-40 text-xl font-bold rounded-lg group border-2 px-6 py-3 my-2 flex items-center hover:bg-[#1F6E8C] hover:border-[#1F6E8C]'>
              Resume
